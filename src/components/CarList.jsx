    ...
    <div className="">
      <div className="p-12 dark:bg-dark dark:text-white bg-slate-100 sm:min-h-[600px] sm:grid sm:place-items-center duration-300">
        ...
        <p data-aos="fade-up" aos-delay="400" className="text-md pb-10">
          "Explore our diverse fleet of rental cars, tailored to suit every
          journey."
        </p>
        <div>
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between items-center text-xl font-semibold">
                    ...
                    <Link
                      to="#"
                      className="border-2 rounded-xl p-2 hover:border-primary"
                    >
                      Book!
                    </Link>
                  </div>
        ...
        <div className="px-40 grid grid-cols-1 place-items-center mt-8">
          <button
            data-aos="fade-up"
